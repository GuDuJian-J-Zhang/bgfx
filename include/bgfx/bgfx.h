...
namespace bgfx
{
	...
	struct Caps
	{
		...
		uint32_t formats[TextureFormat::Count]; //!< Supported texture format capabilities flags:
		                                        ...
		                                        ///    - `BGFX_CAPS_FORMAT_TEXTURE_FRAMEBUFFER_SRGB` - Texture format can be used as sRGB frame buffer (hardware gamma encoding).
	};
	...
	struct Caps
	{
		...
		///   - `BGFX_CAPS_FORMAT_TEXTURE_MIP_AUTOGEN` - Texture format supports auto-generated
		///     mips.
		///   - `BGFX_CAPS_FORMAT_TEXTURE_FRAMEBUFFER_SRGB` - Texture format can be used as
		///     sRGB frame buffer (hardware gamma encoding).
...
>>>>>>> 3c1a6522f (fix srgb related stuff)
