...
#define BGFX_TEXTURE_BUFFER_TEXTURE               UINT64_C(0x0001000000000000) //!< Texture will be used for read back from GPU.
...
#define BGFX_SAMPLER_BUFFER                       UINT32_C(0x00200000)
#define BGFX_SAMPLER_BUFFER_SHIFT                 22

#define BGFX_SAMPLER_BUFFER_MASK                  UINT32_C(0x00200000)
...
#define BGFX_CAPS_FORMAT_TEXTURE_FRAMEBUFFER_SRGB UINT32_C(0x00010000) //!< Texture format can be used as sRGB frame buffer (hardware gamma encoding).
