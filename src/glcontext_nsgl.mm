...
#	include "glimports.h"
	...
	struct SwapChainGL
	{
		SwapChainGL(void* _nwh,NSOpenGLContext *_context, int _width, int _height)
		{
	...
	SwapChainGL* GlContext::createSwapChain(void* _nwh, uint32_t _width, uint32_t _height)
	{
		return BX_NEW(g_allocator, SwapChainGL)(_nwh,(NSOpenGLContext*)m_context, _width, _height);
	}
